<template>
  <div class="pen-effect-config">
        ...
        <t-collapse-panel v-if="editorPen.name !== 'video'" header="动画">
          <template v-if="editorPen.name !== 'line'">
            <t-form-item label="时长">
              <t-input
                v-model:value="editorPen.duration"
                placeholder=""
                :readonly="true"
                :borderless="true"
          ...
          <t-form-item label="动画效果">
            <template v-if="editorPen.name === 'line'">
              <t-select
                v-model:value="editorPen.lineAnimateType"
                :clearable="true"
                placeholder="请选择动画效果"
            ...
            <template v-else>
              <t-select
                v-model:value="editorPen.animateType"
                :clearable="true"
                placeholder="请选择动画效果"
          ...
          <t-form-item label="循环次数">
            <t-input-number
              v-model:value="editorPen.animateCycle"
              theme="column"
              placeholder="默认无限循环"
          ...
          <t-form-item v-if="editorPen.name === 'line'" label="动画线宽">
            <t-input-number
              v-model:value="editorPen.animateLineWidth"
              theme="column"
              placeholder="请输入动画线宽"
          ...
          <t-form-item v-if="editorPen.name === 'line'" label="动画颜色">
            <t-color-picker
              class="w-full"
              v-model:value="editorPen.animateColor"
              format="CSS"
              :show-primary-color-preview="false"
              :color-modes="['monochrome']"
              :clearable="true"
              @change="setOptionFunc('animateColor')"
            />
          </t-form-item>
    ...
    <pen-effect-custom-config
      :options="{ visible: effectCustomVisible }"
      :model-value="editorPen"
      @close="confirmFrames"
      @confirm="confirmFrames"
    />

    <editor-code
      :visible="editorCodeVisible"
      :model-value="editorCodeValue"
      :language="editorCodeLanguage"
